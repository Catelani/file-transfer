...
public class NomeUtilsTest {
  ...
  public void getTipoInterfacePeloNomeArquivo() throws Exception {
    ...
    @NotNull final TipoInterface tipoPropostaAcordo = NomeUtils.getTipoInterfacePeloNomeArquivo("ESCPA1234.DAT");
    @NotNull final TipoInterface tipoRetornoNormal = NomeUtils.getTipoInterfacePeloNomeArquivo("ESCRN1234.DAT");
    @NotNull final TipoInterface tipoRetornoExcecao = NomeUtils.getTipoInterfacePeloNomeArquivo("ESCRE1234.DAT");
    @NotNull final TipoInterface tipoRetornoBoletosSeguintes = NomeUtils.getTipoInterfacePeloNomeArquivo("ESCRB1234.DAT");
    @NotNull final TipoInterface tipoProtocoleRecebimento = NomeUtils.getTipoInterfacePeloNomeArquivo("ESCPR1234.DAT");
